...
export const errorCopy: Record<ErrorCode, ErrorDetails> = {
  ...
  SESSION_EXPIRED: { title: "Setup window closed", detail: () => "Press the Spark reset button to reopen the 15-minute setup window.", action: "Try again after reset", target: "retry" },
